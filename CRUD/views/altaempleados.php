...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="secretaria_admin.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="altaempleados.php">
                    <i class="fas fa-users-cog"></i>
                    <span>Alta empleados</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="asignarqr.php">
                    <i class="fas fa-qrcode"></i>
                    <span>Asginar QR</span></a>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../utilities-border.html">Nosotros</a>
                        <a class="collapse-item" href="../utilities-animation.html">Kits</a>
                        <a class="collapse-item" href="../utilities-other.html">Aliados</a>
                        <a class="collapse-item" href="../utilities-other.html">Portafolio</a>
                        <a class="collapse-item" href="../utilities-other.html">Galeria</a>
                        <a class="collapse-item" href="../utilities-other.html">Contacto</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $SQL = "SELECT empleados.id, empleados.nombre, empleados.apellido_p, empleados.apellido_m, empleados.correo, empleados.curp, empleados.puesto, empleados.qr FROM empleados";
